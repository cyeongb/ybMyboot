...
var empCode = "${sessionScope.code}";
   ...
   $(document).ready(function(){
	// 인사발령정보 날짜 검색 버튼
      $("#appointmentSearch_Btn").click(appointmentList); 
   ...
   function appointmentList(){
      ...
      $.ajax({
         ...
         success : function(data){
            ...
            appointmentTargetGridData.push({
               "No":appointment.No, 
...
<div id="personalAppointInfo_tab">
      <ul>
         <li id = "monthSalary_col">
            <a href="#appointmentInfo_tab">인사발령정보</a>
         </li>
      </ul>
      <div id="appointmentInfo_tab">
         <input id="break_startD" class="ui-button ui-widget ui-corner-all" readonly>~<input id="break_endD"   class="ui-button ui-widget ui-corner-all" readonly>
         <input type="button" class="ui-button ui-widget ui-corner-all" id="appointmentSearch_Btn" value="검색"/><br /><br />
         <input type="button" class="ui-button ui-widget ui-corner-all" id="add_appointment_btn" value="발령추가"/>
         <input type="button" class="ui-button ui-widget ui-corner-all" id="del_appointment_btn" value="발령삭제"/>
         <input type="button" class="ui-button ui-widget ui-corner-all" id="save_Btn" value="저장"/><br /><br />
...
<div id="appointmentTargetInfo_tab">
      <ul>
         <li>
            <a href="#appointmentTarget_tab">발령대상자</a>
         </li>
      </ul>
      <div id="appointmentTarget_tab">
        <input type="button" class="ui-button ui-widget ui-corner-all" id="add_target_btn" value="사원추가"/>
        <input type="button" class="ui-button ui-widget ui-corner-all" id="del_target_btn" value="사원삭제"/><br/><br/>
