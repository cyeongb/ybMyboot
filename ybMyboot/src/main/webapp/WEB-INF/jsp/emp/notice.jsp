...
var empBean={};
	...
	function registEmp(){
		...
		if($("#txt_code").val()== "" || $("#txt_name").val()== "" || $("#txt_dept").val()== "" 
				|| $("#txt_posi").val()== "" || $("#txt_mnum").val()== "" || $("#txt_emain").val()== ""){
			alert("필수입력항목을 채워주세요");
			return;
		}
		
		//------------휴대폰 유효성...
// 		$("#txt_mnum").blind("keyup",function(event){
// 			$("#txt_mnum").val(temp.replace(/\B(?=(\d{3})+(?!\d))/g, ","));
// 		});
...
<div style="width:500px; margin-top: 50px;">	
	...
	<input type="button" class="ui-button ui-widget ui-corner-all" id='btn_crenum' value="사번 생성" maxlength="7"></td></tr>
	<tr><td><font>★이름</font></td><td><input class="ui-button ui-widget ui-corner-all" id='txt_name' type="text" name="emp_name" maxlength="5"></td></tr>
	...
	<tr><td><font>★전화번호</font></td><td><input class="ui-button ui-widget ui-corner-all" id='txt_mnum' type="text" name="mobile_number" maxlength="11"></td></tr>
	...
	<input type="reset"  class="ui-button ui-widget ui-corner-all" value="삭제">
	</form>
	</div>
