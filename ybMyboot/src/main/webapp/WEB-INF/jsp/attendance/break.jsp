...
function showBreakListGrid(){
	var columnDefs = [
	      ...
	      {headerName: "휴가구분코드", field: "restTypeCode",hide:true},
	      {headerName: "휴가구분명", field: "restTypeName",checkboxSelection: true},
...
<!-- 					</td> -->
				...
				<tr>
					<td><font>사유</font></td>
					<td colspan="3"><input id="break_cause" style="width:490px" class="ui-button ui-widget ui-corner-all" >
					</td>
				</tr>
			</table>
			<hr>
		...
		<tr><td><h3 align="center">구분</h3></td><td><input id="selectBreakType" class="ui-button ui-widget ui-corner-all" readonly>
		...
		<hr>
		<div id="breakList_grid" style="height: 230px; width:800px" class="ag-theme-balham"></div>
