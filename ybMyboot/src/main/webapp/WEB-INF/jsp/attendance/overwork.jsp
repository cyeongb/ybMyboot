 ...
 */      
   ...
   function getDatePicker($Obj) {
	      $Obj.datepicker({
	          ...
	          beforeShowDay : function(date){
	                   ...
	                   if($(this).attr('id') == "overwork_startD"){  // attr 속성을 들고 옴
   ...
   function registoverwork(){
	   ...
	   var today =new Date();
	      if($("#selectOverwork").val().trim()==""|| $("#overwork_startD").val().trim()==""||
	         $("#overwork_endD").val().trim()==""|| $("#overwork_endT").val().trim()==""){
	    	  alert("필수사항을 작성해 주세요.")
	         }
...
<!--                <td><input id="overwork_certi" class="ui-button ui-widget ui-corner-all" readonly></td> -->
      ...
      <hr>
      <div id="overworkList_grid" style="height: 230px; width:800px" class="ag-theme-balham"></div>
